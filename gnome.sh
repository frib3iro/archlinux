...
listahacker=(aircrack-ng wifite tcpdump bully reaver hcxdumptool hcxtools termshark cowpatty hashcat)

listahackeryay=(pyrit)
...
echo
echo -e "${S} ${B}Instalando pacotes Hacker${F}"
for i in ${listahacker[@]}
do
    echo -e "${S} ${B}Instalando o pacote $i ${F}"
    sudo pacman -S $i --noconfirm
    echo -e "${S} ${G}Pacote $i instalado com sucesso!!${F}"
