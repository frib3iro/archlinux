...
GerenciadorDeBoot(){
    pacman -S grub efibootmgr networkmanager network-manager-applet dialog mtools dosfstools git linux-headers bluez bluez-utils cups alsa-utils pulseaudio pulseaudio-bluetooth vim wget xdg-utils xdg-user-dirs --noconfirm
}
